            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="" method="post">
                        ...
                        <h6 class="card-title">Resend Verification</h6>
                        <small>Already verified? login <a href="<?php echo BASE_URL; ?>login">here</a>.</small>
                        <hr>
                        <!-- Email -->
                        ...
                        <!-- Button -->
                        <div class="d-grid"><button type="submit" class="btn btn-lg btn-primary btn-sm">Resend Verification</button></div>
