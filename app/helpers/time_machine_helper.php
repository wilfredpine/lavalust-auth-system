...
/**
 * Time Machine Helper
 * https://gist.github.com/wilfredpine/da8c768f1bd0e78971be0fdf78ac484e
 * 
...
/* Count Seconds - count the remaining seconds from two specific date range
 * specify the date using $from and $until parameter
 */
if (!function_exists('count_seconds')) {
    function count_seconds($from, $until)
    {
        $d1 = strtotime($from);
        $d2 = strtotime($until);
        return ceil(($d2 - $d1))/60;
    }
}
